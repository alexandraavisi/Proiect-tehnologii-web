            ...
            <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input type='text' value='Member (MP)' disabled className='w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed'/>
                        <p className="text-xs text-gray-500 mt-1"> MP can manage bugs and assign them.</p>
                    </div>
